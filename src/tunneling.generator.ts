...
export class TunnelingDungeonGenerator implements DungeonGenerator {
  ...
  private replaceFloorRandomly(dungeon: DungeonLevel) {
  ...
  private replaceWallRandomly(dungeon: DungeonLevel) {
